...
## 🧠 Problem Summary
*A one-sentence description of the problem's goal.*

## 📋 Constraints & Edge Cases
- *e.g., Input size: `1 <= nums.length <= 10^4`*
- *e.g., Value range: `-10^9 <= nums[i] <= 10^9`*
...
2.  **Optimal Approach**: A step-by-step, plain-English explanation of the best solution's logic.
