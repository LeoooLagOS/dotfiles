...
*An Alternate Port is a switch port that has a redundant path to the [[Root Bridge]] and is therefore put into a logical blocking state by [[Spanning Tree Protocol (STP)]] to prevent loops.
...
* This port role is the reason [[Spanning Tree Protocol (STP)]] can prevent [[Layer 2 Loops]]. 
