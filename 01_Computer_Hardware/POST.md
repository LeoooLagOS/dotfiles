...
## 🔑 Key Details 
- **What it is:** The very first step in the [[Switch Boot Sequence]]. It's a low-level check of core components. 
- **What it checks:** It verifies the basic operation of the [[CPU]], [[DRAM]], and the part of the [[Flash Memory]] that holds the file system. 
- **Why it exists:** To ensure the hardware is stable enough to proceed with loading the boot loader and, eventually, the full operating system. A failure at this stage indicates a serious hardware problem. 
