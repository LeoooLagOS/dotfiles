...
A data type is a classification that tells the compiler or interpreter how a programmer intends to use some data, determining the values it can hold and the operations that can be performed on it.
