...
*BPDUs are small data frames exchanged between switches that contain the necessary information for the [[Spanning Tree Protocol (STP)]] to elect a [[Root Bridge]] and build a loop-free topology.
...
* BPDUs are the fundamental mechanism used by [[Spanning Tree Protocol (STP)]] to function. 
